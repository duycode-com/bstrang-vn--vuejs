		...
		<div class="flex justify-between">
			...
			<div class="italic">
				<p class="flex items-center">
					<span class="w-20 flex-none">Ngân hàng</span>
					<span class="w-4 flex-none">:</span>
					<span>VietinBank</span>
				</p>
				<p class="flex items-center">
					<span class="w-20 flex-none">Chi nhánh</span>
					<span class="w-4 flex-none">:</span>
					<span>Bắc Hà Nội</span>
				</p>
				<p class="flex items-center">
					<span class="w-20 flex-none">Số TK</span>
					<span class="w-4 flex-none">:</span>
					<span class="font-bold">109.869.634.541</span>
				</p>
				<p class="flex items-center">
					<span class="w-20 flex-none">Chủ TK</span>
					<span class="w-4 flex-none">:</span>
					<span>Bùi Thị Trang</span>
				</p>
			</div>
		</div>
		<div class="flex justify-center font-bold text-xl my-6">HÓA ĐƠN</div>
