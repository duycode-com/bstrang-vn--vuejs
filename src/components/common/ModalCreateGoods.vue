<template>
	...
	>
		...
		<div class="flex items-center mb-2">
			<div class="w-100px flex-none">Group</div>
		...
		<div class="flex items-center mb-2">
			<div class="w-100px flex-none">Unit</div>
		...
		<div class="flex items-center mb-2">
			<div class="w-100px flex-none">Retail Price</div>
			<a-input
		...
		<div class="flex items-center mb-2">
			<div class="w-100px flex-none">Wholesale Price</div>
			<a-input
...
export default {
	setup() {
		return {
			...
			newGoods: reactive({ goodsName: '', group: '', unit: '', retailPrice: '', wholesalePrice: '' }),
            UTILS_GOODSTYPE,
		}
	},
	methods: {
